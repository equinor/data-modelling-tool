...
System_Boundary(data_modelling_tool, "Data Modelling Tool") {
    ...
    Container(data_modelling_tool_api, "Rest API", "Python and Fast API", "The API that handles business logic for DMT.")
...
Container_Ext(data_modelling_storage_service, "Data Modelling Storage Service System", "Python and Fast API", "Handles the storing and retrieving of data.")
