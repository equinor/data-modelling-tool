...
correct_index = [
    {
        "id": "blueprints/propellers/package.json",
        "title": "propellers",
    ...
    {
        "id": "blueprints/propellers/1.0.0/package.json",
        "title": "propellers",
        "description": "cool sintef propeller model blueprints",
        "version": "1.0.0",
    ...
    {
        "id": "blueprints/propellers/1.0.0/ordinary-propeller.json",
        "title": "propeller",
        "description": "A typical propeller blueprint",
        "nodeType": "file",
    },
    {
        "id": "blueprints/propellers/1.0.0/big/package.json",
        "title": "propellers",
    ...
    {
        "id": "blueprints/propellers/1.0.0/big/big-propeller.json",
        "title": "propeller",
        "description": "A typical propeller blueprint",
        "nodeType": "file",
    },
