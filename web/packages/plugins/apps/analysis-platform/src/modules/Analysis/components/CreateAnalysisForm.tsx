...
const hasErrors = (error: Errors) => error["name"] !== "" || error["description"] !== ""
...
const CreateAnalysisForm = (props: CreateFormProps) => {
    ...
    const formHandler = (event: any) => {
        ...
        if (!singleWordFormat.test(analysis.name)) {
            formErrors["name"] = "Invalid operation name! (you cannot have empty name or use any special characters)."
        }
        ...
        <form onSubmit={formHandler}>
            <Wrapper>
                ...
                <TextField
                    ...
                    onChange={handleInputChange}
                    helperText={error.description ? error.description : "Short description about the analysis"}
