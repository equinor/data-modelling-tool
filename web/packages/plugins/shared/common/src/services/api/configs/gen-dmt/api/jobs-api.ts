...
export class JobsApi extends BaseAPI {
    ...
    public jobResult(requestParameters: JobsApiJobResultRequest, options?: any) {
        return JobsApiFp(this.configuration).jobResult(requestParameters.jobId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public jobStatus(requestParameters: JobsApiJobStatusRequest, options?: any) {
        return JobsApiFp(this.configuration).jobStatus(requestParameters.jobId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public removeJob(requestParameters: JobsApiRemoveJobRequest, options?: any) {
        return JobsApiFp(this.configuration).removeJob(requestParameters.jobId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public startJob(requestParameters: JobsApiStartJobRequest, options?: any) {
        return JobsApiFp(this.configuration).startJob(requestParameters.jobId, options).then((request) => request(this.axios, this.basePath));
    }
}
