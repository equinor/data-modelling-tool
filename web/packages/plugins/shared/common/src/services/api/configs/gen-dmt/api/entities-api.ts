...
export class EntitiesApi extends BaseAPI {
     ...
     */
    public instantiateEntity(requestParameters: EntitiesApiInstantiateEntityRequest, options?: any) {
        return EntitiesApiFp(this.configuration).instantiateEntity(requestParameters.basicEntity, options).then((request) => request(this.axios, this.basePath));
    }
}
