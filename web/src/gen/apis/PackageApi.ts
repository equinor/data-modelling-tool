...
export class PackageApi extends runtime.BaseAPI {
  ...
  async findByNameRaw(
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'dataSourceId',
        'Required parameter requestParameters.dataSourceId was null or undefined when calling findByName.'
      )
    }
    ...
    const response = await this.request({
      path: `/packages/{dataSourceId}/findByName/{name}`
        .replace(
          `{${'dataSourceId'}}`,
  ...
  async getRaw(
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'dataSourceId',
        'Required parameter requestParameters.dataSourceId was null or undefined when calling get.'
      )
    }
    ...
    const response = await this.request({
      path: `/packages/{dataSourceId}`.replace(
        `{${'dataSourceId'}}`,
        encodeURIComponent(String(requestParameters.dataSourceId))
      ),
      method: 'GET',
