...
export class DatasourceApi extends runtime.BaseAPI {
  ...
  async getDataSourceRaw(
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'dataSourceId',
        'Required parameter requestParameters.dataSourceId was null or undefined when calling getDataSource.'
      )
    }
    ...
    const response = await this.request({
      path: `/data-sources/{dataSourceId}`.replace(
        `{${'dataSourceId'}}`,
  ...
  async saveRaw(
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'dataSourceId',
        'Required parameter requestParameters.dataSourceId was null or undefined when calling save.'
      )
    }
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'requestBody',
        'Required parameter requestParameters.requestBody was null or undefined when calling save.'
      )
    }
