...
export class DocumentApi extends runtime.BaseAPI {
  ...
  async getByIdRaw(
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'dataSourceId',
        'Required parameter requestParameters.dataSourceId was null or undefined when calling getById.'
      )
    }
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'documentId',
        'Required parameter requestParameters.documentId was null or undefined when calling getById.'
      )
    }
    ...
    const response = await this.request({
      path: `/documents/{dataSourceId}/{documentId}`
        .replace(
          `{${'dataSourceId'}}`,
   ...
   */
  async getByPathRaw(
    requestParameters: GetByPathRequest
  ): Promise<runtime.ApiResponse<{ [key: string]: object }>> {
    if (
      requestParameters.dataSourceId === null ||
      requestParameters.dataSourceId === undefined
      ...
      throw new runtime.RequiredError(
        'dataSourceId',
        'Required parameter requestParameters.dataSourceId was null or undefined when calling getByPath.'
      )
    }
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'path',
        'Required parameter requestParameters.path was null or undefined when calling getByPath.'
      )
    }
    ...
    const response = await this.request({
      path: `/documents-by-path/{dataSourceId}`.replace(
        `{${'dataSourceId'}}`,
        encodeURIComponent(String(requestParameters.dataSourceId))
      ),
      method: 'GET',
  ...
  async updateRaw(
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'dataSourceId',
        'Required parameter requestParameters.dataSourceId was null or undefined when calling update.'
      )
    }
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'documentId',
        'Required parameter requestParameters.documentId was null or undefined when calling update.'
      )
    }
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'requestBody',
        'Required parameter requestParameters.requestBody was null or undefined when calling update.'
      )
    }
